...
Usage:
    43b_merge_context_shards.py [--pattern 'results/datasets/context_features.shard*.csv']
...
from experimental_glycosylation_sites.context_merge import (KEY, ShardError,
                                                            merge_context_shards)

DEFAULT_POPULATIONS = "occupied,internal_control,secretory_unannotated"

parser = argparse.ArgumentParser(description=__doc__)
parser.add_argument("--pattern", default="results/datasets/context_features.shard*.csv")
