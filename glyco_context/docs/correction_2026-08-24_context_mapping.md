...
stay out of reach: 
1. explaining the difference between the two models
2. evaluating whether a *designed* site sits in a plausible environment (plausible compared to
what?)
3. distinguishing a real signal from a compositional confound.
